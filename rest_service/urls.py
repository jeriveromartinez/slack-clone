...
urlpatterns = [
    url(r'^(?P<company>[0-9a-zA-Z_-]+)/room/$', 'rest_service.views.room_by_company', name='api-room'),
    ...
    url(r'^files/(?P<username>[0-9a-zA-Z_-]+)/(?P<type>[a-zA-Z]+)', 'rest_service.views.get_files', name='api-files'),
]
