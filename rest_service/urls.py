...
urlpatterns = [
    url(r'^(?P<company>[0-9a-zA-Z_-]+)/room/(?P<room_name>[0-9a-zA-Z_-]+)/$', 'rest_service.views.room_by_company',
        name='api-room'),
    url(r'^company_room$', 'rest_service.views.room_by_company_filter',
        name='api-room-filter'),
    url(r'room_user_list/(?P<username>[0-9a-zA-Z_-]+)$',
        'rest_service.views.room_by_user_list',
        name='api-room_room_user_list'),
    url(r'room_user/(?P<username>[0-9a-zA-Z_-]+)$',
        'rest_service.views.room_by_user',
        name='api-room_room_user'),
